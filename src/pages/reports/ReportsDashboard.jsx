  ...
  const reports = [
    {
      ...
      description: 'View admission statistics, patient details, and admission trends',
      icon: '📋',
    ...
    <div className="container-fluid">
      <div className="row g-2 g-md-3">
        <div className="col-12">
          ...
          <p className="text-muted mb-3 mb-md-4">Select a report to view detailed analytics and insights</p>
        </div>

        {reports.map((report) => (
          <div key={report.id} className="col-12 col-sm-6 col-lg-6 col-xl-4">
            <Link to={report.path} className="text-decoration-none">
              <div className={`card shadow-sm border-top border-${report.color} h-100 cursor-pointer`} style={{ cursor: 'pointer', transition: 'transform 0.2s' }}>
                ...
                <div className="card-footer bg-white">
                  <span className={`badge text-bg-${report.color}`}>View Report →</span>
                </div>
              </div>
            </Link>
          </div>
            ...
            <div className="col-md-6 col-lg-3">
              <div className="card shadow-sm">
                <div className="card-body text-center">
                  ...
                  <div className="fs-5 fw-bold">₹7.39L</div>
                </div>
              </div>
            </div>
            <div className="col-md-6 col-lg-3">
              <div className="card shadow-sm">
                <div className="card-body text-center">
                  ...
                  <div className="fs-5 fw-bold">₹99K</div>
                </div>
              </div>
            </div>
          </div>
